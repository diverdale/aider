...
and re-spawn server subprocesses each time — defeating eager startup
(`docs/mcp/research.md` D4) and undoing the warm-loop assumption Phase 2
relies on for tool-use during streaming.
